// PARAM: --sets solver td3 --enable ana.int.interval --disable ana.int.def_exc --set ana.activated "['base','threadid','threadflag','mallocWrapper','assert']" --disable sem.assert.refine
